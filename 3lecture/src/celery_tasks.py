...
def example_task(self, name: str = "Hello World", countdown: int = 10):
    """
...
def add_random_task():
    ...
    """
    logger.info("Adding a random task")
    result = example_task.delay(name="Random Task")
    return result.id

@celery_app.task
def send_notification_task(message: str, recipient: str):
    """
    Function to send a notification task
    """
