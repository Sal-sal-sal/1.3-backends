...
class TaskCreateDelay(BaseModel):
    """Schema for creating a new task"""
    title: str = Field(..., min_length=1, max_length=200, description="The title of the task")
    description: Optional[str] = Field(None, max_length=1000, description="The description of the task")
    recipient: str = Field(..., min_length=1, max_length=200, description="The recipient of the notification")
    delay_seconds: int = Field(..., ge=0, description="Delay in seconds before sending the notification")
